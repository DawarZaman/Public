//I did some editions to the Anton Savelyev's code. 

//In order to use pthread.h and unistd.h libraries on Windows, it is better
//to use cygwin to compile and run the code.
...
const int run_time = 30; // seconds the program will wait for to allow all cars to pass
